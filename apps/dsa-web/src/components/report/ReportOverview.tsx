            ...
            <div className="flex items-start justify-between mb-4">
              ...
              {onViewReport && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-sm hover:bg-white/10 transition-colors shrink-0"
                >
